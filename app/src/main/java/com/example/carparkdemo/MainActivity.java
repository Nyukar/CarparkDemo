...
public class MainActivity extends AppCompatActivity {
    ...
    private static final float SMALLEST_DISPLACEMENT = 0.5F; //half of a meter
        ...
        registerButton.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
               ...
               if(userView.getText().toString().equalsIgnoreCase("Jane")) {
                ...
                registration.put("LAT", locA.latitude);
                registration.put("LONG", locA.longitude);
                            ...
                            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                                if (task.isSuccessful()) {
                                    for (QueryDocumentSnapshot document : task.getResult()) {
                                        ...
                                        String displayWord = words[0] + '\n' + words[3] + '\n' +
                                                words[2] + '\n' + words[4] + '\n' + words[5] +
                                                words[6] + '\n' + words[7] + '\n' + '\n' + words[8]
                                        + '\n' + words[9] + '\n' + words[10];

                                       // resultsView.setText(document.getData().toString());
                                        resultsView.setText(displayWord);
